...
return {
    ...
    schema = {
        model = {
            ...
            choices = {
                ["anthropic/claude-haiku-4.5"] = { opts = { can_reason = true, has_vision = false } },
                ["anthropic/anthropic/claude-sonnet-4.5"] = { opts = { can_reason = true, has_vision = false } },
                ["deepseek/deepseek-v3.2"] = { opts = { can_reason = true, has_vision = false } },
                ["moonshotai/kimi-k2-thinking"] = { opts = { can_reason = true, has_vision = false } },
                ["openai/gpt-5.1-codex"] = { opts = { can_reason = true, has_vision = true } },
                ["openai/gpt-4.1"] = { opts = { can_reason = false, has_vision = false } },
                ["x-ai/grok-4.1-fast"] = { opts = { can_reason = true, has_vision = false } },
                ["z-ai/glm-4.6"] = { opts = { can_reason = true, has_vision = false } },
            },
        },
        reasoning_effort = {
            order = 2,
